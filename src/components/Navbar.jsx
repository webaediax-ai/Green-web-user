    ...
    <>
      ...
      <nav
        className={`
          ...
          transition-all duration-300 backdrop-blur-md md:block {/* Hidden on mobile, block on md and larger */}
          ${isScrolled 
            ...
            <div className="flex-shrink-0">
              <Link to="/" className="flex items-center space-x-2">
                <img
                  ...
                  alt="aediax"
                />
                <span className="font-bold text-xl text-gray-800">aediax</span>
              </Link>
            </div>
