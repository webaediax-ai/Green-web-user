      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <m.div variants={itemVariants} className="text-center md:text-left">
            ...
            >
              <p className="text-sm">
                DISCLAIMER: This website is not a commercial enterprise. aediax is a fictitious entity created solely for educational and skill development purposes. No real products are sold, and no actual transactions occur herein. Any resemblance to real businesses, products, or services is purely coincidental.
              </p>
        ...
        >
          <p>© {new Date().getFullYear()} Aediax. No rights reserved.</p>
