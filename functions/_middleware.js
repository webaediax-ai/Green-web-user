...
function generateMetaTags(product, url) {
  const metaDescription = product.description
    ...
    : `Buy ${product.name} online at aediax`;

  const title = `${product.name} | aediax - Premium Stationery`;
  ...
  return `
    ...
    <meta property="og:site_name" content="aediax - Premium Stationery">
    ...
    <meta name="twitter:site" content="@aediax">
